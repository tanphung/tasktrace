...
export async function jobFixture():Promise<Job>{
  const job:Job={id:'test-job',chain_id:'61999',contract:'0x1111111111111111111111111111111111111111',client:'0x2222222222222222222222222222222222222222',workers:{A:'0x3333333333333333333333333333333333333333',B:'0x4444444444444444444444444444444444444444'},status:'REVIEWABLE',terms_hash:'terms',accepted:{A:true,B:true},b_missing:false,created_at:100,accept_deadline:200,review_deadline:2_000_000_000,artifacts:{},claims:{},ledger:{received:'42',issued:'0',emitted:'0',credits:{CLIENT:'0',A:'0',B:'0'}},terms:{title:'Test-only fixture',task:'Explain export eligibility.',verify_source:false,money:{A:{fee:'10',bond:'5',penalty:'3'},B:{fee:'20',bond:'7',penalty:'4'}},step_seconds:60,review_seconds:60,adjudication_seconds:60}};
