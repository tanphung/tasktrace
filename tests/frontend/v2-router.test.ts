...
const valid={id:"release-1",dealId:"deal-1",receiptId:"aa".repeat(32),account:`0x${"11".repeat(20)}`,chainId:chain.id,router,phase:"PENDING",hash:`0x${"22".repeat(32)}`,createdAt:1};
